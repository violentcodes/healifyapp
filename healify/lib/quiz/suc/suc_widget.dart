...
class SucWidget extends StatefulWidget {
  ...
  static String routeName = 'suc';
  static String routePath = '/suc';

  @override
  State<SucWidget> createState() => _SucWidgetState();
}

class _SucWidgetState extends State<SucWidget> with TickerProviderStateMixin {
